<div class="originUI-field">
	...
	<textarea id="embedModal-content" class="originUI-textarea originUI-bgColorSecondary"><script type="text/javascript" src="http://<?php echo $_SERVER['HTTP_HOST'];?>/min-js?f=/js/ad/origin.js" data-auto="{{embedOptions.auto}}" data-close="{{embedOptions.close}}" data-hover="{{embedOptions.hover}}" data-dcopt="true" data-id="{{embedOptions.id}}" data-type="{{embedOptions.type}}" data-xd="local.origin_test_prod" data-init="true"></script></textarea>
