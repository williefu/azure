...
<head>
	...
	<?php
		...
		echo $this->Minify->script(array('jquery', 'angularjs', 'origin'));
		//echo $this->fetch('meta');
		//echo $this->fetch('css');
		//echo $this->fetch('script');
	?>
</head>
<body class="originUI-bgTexture originUI-text route-<?php echo $this->request->url;?>">
	<div id="origin-bar">
		<div class="wrapper">
			<a href="/" id="originBar-logo">Origin</a>
			<a href="javascript:void(0);" id="originBar-settings" class="originUI-icon originUiIcon-settings">Settings</a>
		</div>
	</div>
